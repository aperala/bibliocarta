...
(function() {
  $(function() {
    return $('#search').bind('railsAutocomplete.select', function(event, data) {
      $('#search-form').submit();
    });
  });
...
(function() {
  $(".sliding-panel-content").ready(function() {
...
(function() {
  $(".c-places.a-index").ready(function() {
    var map, setPopups;
...
(function() {
  $(".c-users.a-show").ready(function() {
    ...
    $.getJSON('/users/id'.json, function(geojsonuser) {
      ...
      myLayer = L.mapbox.featureLayer().addTo(map);
      myLayer.on('layeradd', setPopups);
      return myLayer.setGeoJSON(geojsonuser);
    });
