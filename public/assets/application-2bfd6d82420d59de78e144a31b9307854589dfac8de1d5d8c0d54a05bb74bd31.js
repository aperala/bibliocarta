...
(function() {
  $(".c-places.a-index").ready(function() {
    ...
    setPopups = function(e) {
      ...
      popupContent = '<div class="popup">' + '<a href="/places/' + (properties != null ? properties.id : void 0) + '">' + (properties != null ? properties.name : void 0) + '</a>' + '<p>Top title: <em>' + (properties != null ? properties.title : void 0) + '</em></p>' + '<a href="/places/' + (properties != null ? properties.id : void 0) + '">' + 'Total books: ' + (properties != null ? properties.books : void 0) + '</a>' + '</div>';
...
(function() {
  $(".c-users.a-show").ready(function() {
    ...
    setPopups = function(e) {
      ...
      marker = e.layer;
      properties = (ref = marker.feature) != null ? ref.properties : void 0;
      popupContent = '<div class="popup">' + '<a href="/places/' + (properties != null ? properties.id : void 0) + '">' + '<h2>' + (properties != null ? properties.name : void 0) + '</h2>' + '</a>' + '<p>Books logged: ' + (properties != null ? properties.total : void 0) + '<ul class="user-books">' + (properties != null ? properties.titles : void 0) + '</ul></p>' + '</div>';
      if (marker.bindPopup != null) {
        return marker.bindPopup(popupContent, {
          closeButton: true,
          minWidth: 200
    ...
    $.getJSON('/users/id'.json + new Date().getTime(), function(geojsonuser) {
      var myLayer;
      myLayer = L.mapbox.featureLayer().addTo(map);
      myLayer.on('layeradd', setPopups);
